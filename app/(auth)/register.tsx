    ...
    >
      ...
      >
        ...
        <View style={styles.roleSelector}>
          ...
          >
            <Ionicons name="person" size={20} color={role === "student" ? "#fff" : Colors.textSecondary} />
          ...
          >
            <Ionicons name="shield-checkmark" size={20} color={role === "admin" ? "#fff" : Colors.textSecondary} />
